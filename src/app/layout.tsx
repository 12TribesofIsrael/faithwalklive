...
const baseDescription = stats.isComplete
  ? `Faith Walk Philly: Minister Zay COMPLETED the 3,000-mile Philly-to-California Faith Walk on ${stats.completedDate}, day ${stats.totalDays}, crossing the California state line on foot after being struck by a car in Indiana and returning to the road five days later. The full route map, every checkpoint, ${stats.clipCount} stream clips, scripture, and the HMBL University fundraiser. Sponsored by AI Bible Gospels.`
  : stats.isPaused
...
const eventNode = stats.isComplete
  ? {
      ...
      description:
        "Faith Walk Philly: Minister Zay (Isaiah Thomas) walked 3,000 miles from Philly (Philadelphia, Pennsylvania) to California on foot, streaming daily on Twitch, to fund HMBL University — a trade school for Philadelphia teens. He completed the walk on July 27, 2026, his 124th day, crossing the California state line. He was struck by a vehicle in Indiana on April 28, 2026 and returned to the road five days later. A walk of faith, not a publicity stunt or charity race.",
